    ...
    <div class="container my-4">
        ...
        <table class="table table-bordered border-danger my-3">
            ...
            <tbody>
                ...
                <tr>
                    <td class="routinedate">Exam</td>
                    <td><a href='https://us05web.zoom.us/j/5152750300?pwd=RDRSWGxqT0pIUWNPcXIyTU1pSFJZUT09'
                            target="_blank">RK Sir</a></td>
                    <td><a href='https://us04web.zoom.us/j/9112900414?pwd=YU80RXd1V0JwVVFkK0JOZWVMSDJUQT09'
                            target="_blank">INL Miss</a></td>
                </tr>
            </tbody>
        </table>
    </div>
